...
| **ASPxBinaryImage**     | -                  | -                                                 | Uploading disabled. To enable it, set the [EditingSettings.Enabled](http://help.devexpress.com/#AspNet/DevExpressWebBinaryImageEditingSettings_Enabledtopic) to **true**. The uploaded content is saved to a byte array. 
