...
namespace SecurityBestPractices.Mvc.Models {
    public class EditFormItem {
        ...
        public decimal StatusNumericType { get; set; }
        public string StatusTextType { get; set; }
    ...
    public static class EditFormItems {
        ...
        static EditFormItems() {
            ...
            items.Add(new EditFormItem { Id = 3, Price = 30, ProductName = "=cmd|' /C calc'!'!A1'", Url = "https://devexpress.com", UrlCaption = "Link 3", StatusNumericType = -10, StatusTextType = "-10%" });
        }
